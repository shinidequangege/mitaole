...
<div class="recovery">
    <div class="page2">
        <div class="heat_l" style="width:276px;">
            <div class="heat_img"><img src="${product.modelImg}" width="264" height="197" /></div>
        </div>
        <div class="heat_new">
            <fmt:formatNumber var="price" value="${product.modelPrice/100}" pattern="#0"/>
            <input type="hidden" name="typeid" id="typeid" value="" />
            <dl>
                <dt><span>请选择一种回购方式</span><a href="goods/info/21025.html">重新评估</a></dt>
                <dd class="clearfix heat_on" name="1">
                    <div class="heat_yellow"> <img src="<%=basePath%>/images/new_jian.png" class="new_jian" />
                        ...
                        <div class="yellow_r"> <span>全网最高</span>
                            <div id="pg_price" class="digits"></div>
                            <span>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;官方直收</span>
                            <div class="clear"></div>
                        </div>
                    </div>
                    <input type="button" value="立即下单" class="heat_input" onclick="new_addcart('ajax/new_addcart.html','sub','00676fdb772fb0a63796fb07b4f134ef')" />
                    <a href="javascript:;" class="heat_hg" onclick="new_addcart('ajax/new_addcart.html','add','00676fdb772fb0a63796fb07b4f134ef')">加入回购车</a> </dd>
            </dl>
            <div class="heat_xin" style="margin-top:0">每成交一笔将为贫困地区的孩子捐赠1元 &nbsp;</div>
        </div>
        <script>
            setNumber($("#pg_price"),${price});
            /*==选择==*/
...
<script>
    function _nav(name,id,total,is){
        for(var i=1;i<=total;i++){
            if(!is) {document.getElementById(name+i).className='';}
            document.getElementById(name+"_list"+i).style.display='none';
        }
        if(!is) {document.getElementById(name+id).className='on';}
...
<div class="content page2">
    ...
    <div class="side">
        ...
        <div class="bar1">
            <a class="on" id="nav_s1">回购承诺</a>
            <a id="nav_s2">交易评价(999+)</a><a id="nav_s3">了解我们如何质检</a> </div>
        <div class="list" id="nav_s_list1">
            ...
            <div id="nav_p_list1" class="nav_p_list"><img src="<%=basePath%>/images/new_images/zb3.png" /></div>
            <div id="nav_p_list2" class="nav_p_list" style="display:none"><img src="<%=basePath%>/images/new_images/zb4.png" /></div>
            <div id="nav_p_list3" class="nav_p_list" style="display:none"><img src="<%=basePath%>/images/new_images/zb5.png" /></div>
            <div id="nav_p_list4" class="nav_p_list" style="display:none"><img src="<%=basePath%>/images/new_images/zb6.png" /></div>
            <div id="nav_p_list5" class="nav_p_list" style="display:none"><img src="<%=basePath%>/images/new_images/zb7.png" /></div>
            <div id="nav_p_list6" class="nav_p_list" style="display:none"><img src="<%=basePath%>/images/new_images/zb8.png" /></div>
        </div>
    ...
    <div class="notes">
        ...
        <dl>
            <dd>
                <div class="img"><img src="<%=basePath%>/images/new_images/icon12.gif" /></div>
                <div class="txt">
                    <h2>取消密码</h2>
            ...
            <dd>
                <div class="img"><img src="<%=basePath%>/images/new_images/icon13.gif" /></div>
                <div class="txt">
                    <h2>退出账户</h2>
            ...
            <dd>
                <div class="img"><img src="<%=basePath%>/images/new_images/icon14.gif" /></div>
                <div class="txt">
                    <h2>回收过程安全吗？</h2>
            ...
            <dd class="no">
                <div class="img"><img src="<%=basePath%>/images/new_images/icon15.gif" /></div>
                <div class="txt">
                    <h2>价格会不会有变动？</h2>
...
<div class="pai_box pai_give"> <img src="<%=basePath%>/images/new_images/pai_close.png" class="pai_close1" />
    <p><img src="<%=basePath%>/images/new_images/70.png" /></p>
    <div class="pai_bottom">
        <input type="button" value="领取现金" class="pai_btn1" />
    </div>
</div>
<div class="pai_cai pai_success">
    <img src="<%=basePath%>/images/new_images/pai_close.png" class="pai_close2" />
